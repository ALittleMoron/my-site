...
- Матрица компетенций: нормализованные локализованные листы, разделы и подразделы, поиск, табличная сетка, детальные ответы, публичные SEO-страницы вопросов, пикер структуры в админке и внешние ресурсы
- Статьи: RU/EN-контент, папки, теги, поиск, фильтры по датам/тегам, управление публикацией и SSR-страницы публичных статей
- Защищённая панель модератора/администратора: создание, редактирование, публикация и снятие с публикации статей и вопросов матрицы, плюс admin-only управление командой
...
- PASETO-аутентификация для защищённого режима модератора/администратора с блокировкой неактивных аккаунтов
