...
- [Приватная база знаний](../docs/knowledge-database.md)
...
- Приватная база знаний для владельца/администраторов: изолированные по автору люди и памятные даты,
  защищённые фото/вложения и отдельный непубличный MinIO bucket
- Самостоятельный ролевой dashboard админ-панели с горизонтальными вкладками разделов и
  запоминаемыми складными панелями: дни рождения и годовщины на текущий/следующий месяц,
  перелистываемый месячный календарь и встроенные операционные инструменты для
  владельца/администраторов; модераторы получают рабочую сводку матрицы компетенций
