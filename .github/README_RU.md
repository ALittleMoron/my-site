...
- Приватная база людей для владельца/администраторов: изоляция по автору, типизированные данные и
  связи, теги, защищённые фото/вложения и отдельный непубличный MinIO bucket
