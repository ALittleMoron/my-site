...
## Контекст
Необходимо выбрать архитектурный подход для личного сайта-портфолио с блогом и интерактивной матрицей компетенций. Требования: демонстрация технических навыков, поддержка различных точек входа (API, HTMX views, CLI), чистота кода, тестируемость, масштабируемость.
...
- **Структура**: litestar (API + HTMX), CLI
- **Компоненты**: контроллеры, views, CLI команды
