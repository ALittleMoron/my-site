...
- [ ] Починить статику на minio и сервисе backup'ов.
...
- [ ] Простой импорт уже подготовленных данных в формате JSON
- [ ] Переделать админку на litestar
  ...
  - [ ] Провести смоук-тест
    ...
    - [ ] Запустить docker-compose и проверить работу смежных сервисов
