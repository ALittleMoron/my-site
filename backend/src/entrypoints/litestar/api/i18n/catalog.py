...
MESSAGES: Mapping[LanguageEnum, LanguageMessages] = {
    LanguageEnum.RU: {
        ...
        "siteBuild.quality.body": (
            ...
            "пользователя, а cookie endpoints требуют CSRF guard header и Fetch Metadata check. "
    ...
    LanguageEnum.EN: {
        ...
        "siteBuild.quality.body": (
            ...
            "active session and current user role, while cookie endpoints require a CSRF guard "
            "header and Fetch Metadata check. "
