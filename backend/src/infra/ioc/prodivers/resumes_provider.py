...
from core.resumes.use_cases import AbstractResumesUseCase, ResumesUseCase
...
class ResumesProvider(Provider):
    ...
    @provide(scope=Scope.REQUEST)
    async def provide_resumes_use_case(self, storage: ResumesStorage) -> AbstractResumesUseCase:
