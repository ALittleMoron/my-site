...
run_deploy_env_configuration_check() {
    ...
    require_file_contains "$manifest_file" '"OWNER_INIT_ENABLED"' "owner init enabled manifest entry"
    ...
    require_file_contains "$rendered_env" 'OWNER_INIT_ENABLED="true"' "rendered owner init enabled"
